    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-brand-dark/95 backdrop-blur-md shadow-lg">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 text-brand-cream hover:text-white transition shrink-0">
          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-6">
            <Link to="/" className="text-brand-cream text-sm hover:text-white transition">Inicio</Link>
            <Link to="/tours" className="text-brand-cream text-sm hover:text-white transition">Tours</Link>
            <Link to="/accommodations" className="text-brand-cream text-sm hover:text-white transition">Hospedajes</Link>
            <Link to="/navegar" className="text-brand-cream text-sm hover:text-white transition">Navegar</Link>
            {currentUser && (
              <>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-brand-cream hover:text-white transition">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-brand-cream hover:text-white transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {currentUser ? (
              <div className="dropdown dropdown-end hidden sm:block">
                <label tabIndex={0} className="btn btn-sm bg-brand-cream text-brand-dark hover:bg-white border-0 gap-2">
              ...
              <div className="hidden md:flex items-center gap-2">
                <Link to="/login" className="btn btn-sm btn-ghost text-brand-cream text-sm hover:text-white">Iniciar Sesión</Link>
                <Link to="/register" className="btn btn-sm bg-brand-blue text-white hover:bg-brand-blue/80 border-0 rounded-full px-4">
                  Registrarse
                </Link>
              </div>
            )}
